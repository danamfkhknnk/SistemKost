<div class="pt-16 relative overflow-hidden" id="kontak">
    ...
    <div class="container ">
            ...
            <div class="">
              <div class="flex items-center justify-center py-2">
                <iframe
                  ...
                  class="rounded-xl shadow-md lg:w-[625px] lg:h-[240px] md:w-[300px] md:h-[300px]  w-[250px] h-[250px]"
                  loading="lazy"
      ...
      <div>
        <div class="text-center py-5 border-t-2 border-gray-300/50 bg-primary text-white">Copyright © Kost Putra Tentrem Mulyo 2024</div>
      </div>
    </div>
  </div>