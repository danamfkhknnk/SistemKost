...
<form class="mx-auto pl-2" method="POST" action="{{url('/admin/pengguna/tambah')}}" >
  ...
  <div class="relative z-0 w-full mb-4 group">
    ...
    <input id="nama" class="text-sm w-full px-4 py-2 border border-solid border-gray-300 rounded" type="text" placeholder="Nama Lengkap" name="nama" value="{{ old('nama')}}" autoFocus />
    @error('nama')
