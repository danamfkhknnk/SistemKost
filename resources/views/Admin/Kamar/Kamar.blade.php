...
<div class="flex flex-column sm:flex-row flex-wrap space-y-4 sm:space-y-0 items-center justify-between pb-2">
    <div class="flex">
        <h2 class="uppercase text-xl p-2 font-bold">Data kamar</h2> 
    ...
    <div class="flex gap-4">
      <div class="pt-2">
          <a href={{url('admin/kamar/tambah')}} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
        ...
        @foreach ($kamars as $kamar)
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="flex px-6 py-4">
                  <a href={{url('admin/kamar/'.$kamar->id.'/edit')}} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                  ...
                  <a href={{url('admin/kamar/'.$kamar->id.'/delete')}} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
                    <svg class="w-6 h-6 text-gray-800 dark:text-white" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" viewBox="0 0 24 24">
