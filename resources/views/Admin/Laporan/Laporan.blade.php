...
<div class="flex flex-column sm:flex-row flex-wrap items-center justify-between pb-2">
        <div class="div">
            <h2 class="uppercase text-xl p-2 font-bold">Laporan Keuangan | Profit Total Rp. {{number_format($jumlahMasuk, 0, ',', '.')}}</h2> 
        </div>
        <div class="flex gap-4">
            ...
            <div class="flex gap-1 ">
                  ...
                  <a href="{{ route('admin.laporan.pdf', ['cari' => request('cari')]) }}" class="text-white lg:px-3 px-1 py-1 lg:py-2 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Download PDF</a>
      ...
      <tbody>
        @foreach ($laporans as $laporan)
          <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
              ...
              <td class="px-6 py-4">
                @if ($laporan->item)
                <a href={{url('admin/laporan/'.$laporan->id.'/delete')}} class="font-medium text-blue-600 dark:text-blue-500 hover:underline">
