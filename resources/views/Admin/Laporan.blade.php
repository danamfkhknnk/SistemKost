...
<div class="flex flex-column sm:flex-row flex-wrap items-center justify-between pb-2">
        ...
        <div class="flex gap-1 ">
            ...
            <a href="{{ route('admin.laporan.pdf', ['cari' => request('cari')]) }}" class="text-white px-3 bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Download PDF</a>
        </div>
